...
def result():
    ...
    root.withdraw()
    top = Toplevel(root)
    #Stop.tk.call('wm','iconphoto',top._w,PhotoImage(file='game.png'))   #add any image as icon of game
...
print("Welcome to CID")[::-1]''':'DIC ot emocleW',
...
options = [
    ...
    ['CID to Welcome ','Welcome to CID',ans[3],'Error'],
